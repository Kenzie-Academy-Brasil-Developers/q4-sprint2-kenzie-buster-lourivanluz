...
export class modifiquedName1649431965534 implements MigrationInterface {
    name = 'modifiquedName1649431965534'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "stock" RENAME CONSTRAINT "UQ_3a81981dd7298746bd3a90ceb9d" TO "UQ_68935c1c259c4b4156a01711bb2"`);
        await queryRunner.query(`ALTER TABLE "movies" RENAME COLUMN "stockidId" TO "stockId"`);
        await queryRunner.query(`ALTER TABLE "movies" RENAME CONSTRAINT "UQ_4ac7eefa68ad88b4757fce38378" TO "UQ_5106abe208463529d022dfa86d5"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "movies" RENAME CONSTRAINT "UQ_5106abe208463529d022dfa86d5" TO "UQ_4ac7eefa68ad88b4757fce38378"`);
        await queryRunner.query(`ALTER TABLE "movies" RENAME COLUMN "stockId" TO "stockidId"`);
        await queryRunner.query(`ALTER TABLE "stock" RENAME CONSTRAINT "UQ_68935c1c259c4b4156a01711bb2" TO "UQ_3a81981dd7298746bd3a90ceb9d"`);
